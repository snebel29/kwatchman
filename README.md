...
kwatchman is a tool to watch for k8s resources changes and trigger handlers, find additional information in [this blog post](https://suntzusays.dev/2019/08/10/kwatchman/)
